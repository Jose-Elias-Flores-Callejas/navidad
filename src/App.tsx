...
function App() {
  ...
  useEffect(() => {
    ...
    const videoEntries = mediaEntries.filter(
      (entry): entry is Extract<MediaEntry, { type: 'video' }> => entry.type === 'video',
    )
    ...
    const createDecorations = () => {
      ...
      titleCtx.fillText('Rosi Imperialista ♥️', 512, 130)
  ...
  return (
    <div className="app-root">
      ...
      <div id="ui-layer">
        <div className="guide">
          Ratón: arrastra para orbitar, rueda para acercar. WASD/QE ajustan la cámara. 1/2/3 cambian de modo.
        </div>
        {!hasStarted && (
